#include "../stdafx.h"
#include "../../../JARVISCoreModules/CoreModules/Database/ExtendedPluginDB/Field.h"

BOOST_AUTO_TEST_CASE(FieldWriteNormalCase)
{
	std::string filename = "/var/www/HTML-Media-Center/JARVIS/Tests/ExtendedDatabaseTests/TestData/Music/Songs/bpm.edb";
...
{
	ExtendedDatabase::Field<int, int> field("/var/www/HTML-Media-Center/JARVIS/Tests/ExtendedDatabaseTests/TestData/Music/Songs/1:20-2:22.edb");
