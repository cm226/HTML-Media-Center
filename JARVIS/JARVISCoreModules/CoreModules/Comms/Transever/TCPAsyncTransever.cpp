...
TCPAsyncTransever::TCPAsyncTransever(boost::asio::io_service& io_service, int port, TranseverConnectionFactory& factory) :
...
{
	boost::shared_ptr<ITranseverConnection> new_connection =
...
void TCPAsyncTransever::handle_accept(boost::shared_ptr<ITranseverConnection> new_connection,
