<embed type="application/x-vlc-plugin" name="VLC" autoplay="yes" loop="no" volume="100" width="640" height="480" target="../../<?php echo str_replace(" ", "%20", $URL[0]['Episode']['filePath']); ?>">
