#include "../stdafx.h"
#include "../../../ServerCoreModules/CoreModules/Database/ExtendedPluginDB/SubCatagory.h"

BOOST_AUTO_TEST_CASE(SubCatagoryNormalCase)
{
	ExtendedDatabase::SubCatagory subCat("/var/www/HTML-Media-Center/Server/Tests/ExtendedDatabaseTests/TestData/Music/Songs/","Songs");
