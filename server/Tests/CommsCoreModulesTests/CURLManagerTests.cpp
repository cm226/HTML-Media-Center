...
#include "../../ServerCoreModules/CoreModules/Comms/CURL/CurlManager.h"
#include "../../ServerCoreModules/CoreModules/Comms/JSON/JSONCURLRequest.h"
...
BOOST_AUTO_TEST_CASE(downloadFileTest)
{
	CommsNS::CurlManager curlMan;
	#ifdef WIN32
		std::string downloadLocation = "C:\\wamp\\www\\HTML-Media-Center\\Server\\Server\\test.png";
	#else
		std::string downloadLocation = "/var/www/HTML-Media-Center/Server/Server/test.png";
	#endif
...
BOOST_AUTO_TEST_CASE(downloadToFileThatExsists)
{
	...
	bool worked = curlMan.downloadItemToFile("http://g-ecx.images-amazon.com/images/G/02/gno/beacon/BeaconSprite-UK-02._V397961423_.png","C:\\wamp\\www\\HTML-Media-Center\\Server\\TestDF\\ExistingImage\\test.png");
	
	BOOST_CHECK_EQUAL(true,worked);
	BOOST_CHECK_EQUAL(true,boost::filesystem::exists( "C:\\wamp\\www\\HTML-Media-Center\\Server\\TestDF\\ExistingImage\\test.png"));
