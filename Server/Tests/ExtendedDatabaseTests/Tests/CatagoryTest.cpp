#include "../stdafx.h"
#include "../../../ServerCoreModules/CoreModules/Database/ExtendedPluginDB/Catagory.h"


BOOST_AUTO_TEST_CASE(CatagoryListSubs)
{
	ExtendedDatabase::Catagory catagory("/var/www/HTML-Media-Center/Server/Tests/ExtendedDatabaseTests/TestData");
...
BOOST_AUTO_TEST_CASE(CatagoryCreateSubCat)
{
	...
	std::string subCatToCreateDir = "/var/www/HTML-Media-Center/Server/Tests/ExtendedDatabaseTests/TestData/"+subCatName;
