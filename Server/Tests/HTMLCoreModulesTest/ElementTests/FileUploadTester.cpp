#include "../stdafx.h"
#include "../../../ServerCoreModules/CoreModules/HTMLRendere/Elements/FileUpload.h"
...
BOOST_AUTO_TEST_CASE(FileUploadgetTextTest)
{
	...
	std::string teargetHTML ="<div id=\"fileUpload\"><div id=\"drop-files\" ondragover=\"return false\"> <!-- ondragover for firefox -->"
				"Drop Files Here"
			"</div>"
