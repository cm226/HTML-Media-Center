...
bool AutoUpdater::CheckForUpdate(
    ...
    output = this->coreMod->getTaskList()->RunSystemCommand(
        "(cd /home/craig/Programming/Server/HTML-Media-Center/Server/ && git pull origin master)",
        normal_exit);
...
bool AutoUpdater::BuildUpdate(
    ...
    if(Config::GetInstance()->Live()){
        updateCMD = "/home/craig/Programming/Server/HTML-Media-Center/Server/BuildAll.sh Release";
    } else {
        updateCMD = "/home/craig/Programming/Server/HTML-Media-Center/Server/BuildAll.sh Debug";
    }
